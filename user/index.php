...
<?php 
   ...
   if(isset($_POST['userID'])){
	   ...
	   $safeDate = $_SESSION['save_life_date']= $crntDate;
						...
						<div class="panel-body">
							...
							<?php
								...
								if($safeDate == '0'){
									...
									<button style="margin-top: 20px;" name="date" id="save_the_life" type="submit" class="btn btn-lg btn-danger center-aligned ">Donate Blood</button>
								</form>';
									...
									<button style="margin-top: 20px;" name="date" id="save_the_life" type="submit" class="btn btn-lg btn-danger center-aligned ">Donate Blood</button>
										...
										<span> You have donated your blood. You can donate your blood after three months. We are very grateful to you.</span>
									</div>';
